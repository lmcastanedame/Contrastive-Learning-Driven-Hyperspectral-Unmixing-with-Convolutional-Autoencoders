...
def training_input_fn_tf(hsi, patch_size, patch_number, alpha_value=None):
    ...
    patches = tf.reshape(patches, [-1, patch_size, patch_size, hsi.shape[-1]])[:patch_number] # Reshape to (N, patch_size, patch_size, C)
    ...
    for dataset in datasets:
        ...
        for folder, params_dict in results_folders.items():
            ...
            if folder not in pre_generated_data:
                ...
                # Pre-generate augmentations and extract patches
